<template>
  <div class="p-8 bg-gray-50 min-h-screen">
    <h1 class="text-3xl font-bold text-center text-gray-800 mb-8">Stock Information</h1>
    ...
    <div v-else class="overflow-x-auto bg-white rounded-lg shadow-lg">
      <table class="min-w-full divide-y divide-gray-200">
        ...
        <tbody class="bg-white divide-y divide-gray-200">
          <tr v-for="stock in stocks" :key="stock.ticker" class="hover:bg-gray-50 transition-colors">
...
const { stocks, error, loading } = storeToRefs(stockStore);
